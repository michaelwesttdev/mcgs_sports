...
export default function SettingsPage() {
    ...
    const [pointsType, setPointsType] = useState<"individual" | "team">("individual")
    ...
    const removePointAllocation = (type: "individual" | "team", place: number) => {
                ...
                <TabsContent value="ageGroups">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configure age groups for competition categories</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid gap-6">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium mb-4">Current Age Groups</h3>
                                    <ScrollArea className="h-[200px] rounded-md border p-4">
                                        <div className="grid gap-4">
                                            {Object.entries(settings.ageGroups).map(([name, value]) => (
                                ...
                                Ages {value[0]} to {value[1]}
                                                    ...
                                                    <Button variant="ghost" size="icon" onClick={() => removeAgeGroup(name)}>
                ...
                <TabsContent value="metrics">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configure metrics and their validation patterns</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid gap-6">
                                <div className="grid gap-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                id="newMetricRegex"
                                                placeholder="e.g. ^(0|[1-9]\d*)(\.\d+)?$"
                                                value={newMetricRegex}
                                                onChange={(e) => setNewMetricRegex(e.target.value)}
                                            />
                                        </div>
                                    </div>
                                            ...
                                            {Object.entries(settings.metrics).map(([name, regex]) => (
                                                <div key={name} className="flex justify-between items-center p-2 rounded-md border">
                                                    <div>
                                                        ...
                                                        <span className="text-sm font-mono">{regex}</span>
                                                    </div>
                                                    <Button variant="ghost" size="icon" onClick={() => removeMetric(name)}>
                                                        <Trash2 className="h-4 w-4 text-destructive" />
                                                    </Button>
                                                </div>
                                            ))}
                ...
                <TabsContent value="points">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Configure points awarded for placements</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid gap-6">
                                <Tabs
                                    value={pointsType}
                                    onValueChange={(value) => setPointsType(value as "individual" | "team")}
                                    className="w-full"
                                >
                                    ...
                                    <TabsContent value="individual" className="pt-4">
                                        <div className="grid gap-4">
                                            ...
                                            <Button onClick={addPointAllocation} className="w-full md:w-auto">
                                                <Plus className="mr-2 h-4 w-4" />
                                        ...
                                        <div>
                                            <h3 className="text-lg font-medium mb-4">Current Individual Points</h3>
                                            <ScrollArea className="h-[200px] rounded-md border p-4">
                                                <div className="grid gap-4">
                                                    {settings.points.individual &&
                                                        Object.entries(settings.points.individual)
                                                            ...
                                                            .map(([place, points]) => (
                                                                <div key={place} className="flex justify-between items-center p-2 rounded-md border">
                                                                    <div>
                                                                        <Badge variant="outline" className="mr-2">
                                                                            Place {place}
                                                                        </Badge>
                                                                    ...
                                                                    <Button
                                                                        variant="ghost"
                                                                        size="icon"
                                                                        onClick={() => removePointAllocation("individual", Number.parseInt(place))}
                                                                    >
                                                                        <Trash2 className="h-4 w-4 text-destructive" />
                                                                    </Button>
                                                                </div>
                                    ...
                                    <TabsContent value="team" className="pt-4">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-medium mb-4">Current Team Points</h3>
                                            <ScrollArea className="h-[200px] rounded-md border p-4">
                                                <div className="grid gap-4">
                                                            ...
                                                            .map(([place, points]) => (
                                                                <div key={place} className="flex justify-between items-center p-2 rounded-md border">
                                                                    ...
                                                                    <Button
                                                                        variant="ghost"
                                                                        size="icon"
                                                                        onClick={() => removePointAllocation("team", Number.parseInt(place))}
                                                                    >
                                                                        <Trash2 className="h-4 w-4 text-destructive" />
                                                                    </Button>
                                                                </div>
