...
export default function Participants() {
    ...
    const searched = handleSearch(participants, {
        ...
        <div className="flex-1 h-full flex flex-col">
            <div className="shrink-0 px-4 py-2 flex justify-between items-center border-b">
                <div className='flex-1 flex gap-8 items-center p-3'>
                    <h1 className="text-lg font-bold">Participants ({searchQuery?`${searched.length}/${participants.length}`:participants.length})</h1>
                    <DropdownMenu>
