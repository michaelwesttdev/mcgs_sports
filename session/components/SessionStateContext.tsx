...
import { useSessionHelper } from "./useSessionHelper";
...
const SessionStateContext = createContext<ReturnType<typeof useSessionHelper> &{sessionId:string} | undefined>(undefined);

export const SessionStateProvider: React.FC<{ sessionId: string; children: React.ReactNode }> = ({ sessionId, children }) => {
  const sessionHelper = useSessionHelper(sessionId);
